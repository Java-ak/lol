...
sudo_users = {SUDO,1295339524,1634565473,859213488,1634565473,1398830949,}   
...
{{text = 'مبرمج السورس',url="t.me/Dev_Ah8"}},
{{text = 'مطور السورس',url="t.me/uu_mody"}},
...
if text == 'مطور السورس' or text == 'مودي' or text == 'مودي' then
local Text = [[
[DEV mody](t.me/uu_mody)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور السورس',url="t.me/uu_mody"}},
...
if text == 'مبرمج سورس ديشا' or text == 'احمد' or text == 'المصري' then
local Text = [[
[ 𝙳𝙴𝚅 𝙰𝙷𝙼𝙴𝙳 𝙰𝙻𝙼𝚂𝚁𝚈 ](t.me/Dev_Ah8)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مبرمج سورس ديشا',url="t.me/Dev_Ah8"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mo1ibrahim&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if result.sender_user_id_ == tonumber(1634565473) then
...
if tonumber(result.id_) == tonumber(1634565473) then  
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب")
return false 
end
...
if tonumber(result.id_) == tonumber(1398830949) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر المبرمج احمد المصري")
return false 
end
if tonumber(result.id_) == tonumber(1634565473) then  
send(msg.chat_id_, msg.id_, "لا تسطيع حظر مطور السورس عام")
